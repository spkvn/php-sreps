...
@section('content')
    <div class="row my-2 py-2 bg-green rounded-corners">
        <div class="col-9">
            ...
            <p>Here's the form to update the sale to <strong>{{$sale->customer}}</strong> of {{$sale->code}}</p>
        </div>
            ...
            <form action="{{route('sales.update', $sale->id)}}" method="POST">
                ...
                <div class="row py-1">
                    <div class="col">
                        ...
                        <input type="text" name="customer" value="{{$sale->customer}}" class="form-control" placeholder="Customer Name">
                    </div>
					
                    <div class="col">
                        <label for="code">Code:</label>
                        <input type="text" name="code" value="{{$sale->code}}" class="form-control" placeholder="Product Code">
                    </div>
					
                    <div class="col-3">
                        <label for="quantity">Quantity:</label>
                        <input type="number" name="quantity" value="{{$sale->quantity}}" class="form-control" placeholder="Quantity of Product">
                    </div>
					
                    <div class="col-3">
                        <label for="total">Total:</label>
                        <input type="number" name="total" value="{{$sale->total}}" class="form-control" placeholder="Total Price">
                    </div>
				</div>
