            ...
            <form action="{{route('sales.update',$sale->id)}}" method="POST">
                ...
                <div class="row py-1">
                    <div class="col">
                        ...
                        <input type="text" name="customer" class="form-control" placeholder="Customer Name" value="{{$sale->customer}}">
                    </div>
                    <div class="col">
                        <label for="code">Code:</label>
                        <input type="text" name="code" class="form-control" placeholder="Sale Code" value="{{$sale->code}}">
                    </div>
                </div>
                <div class="row py-1">
                    <div class="col">
                    ...
                    <input type="hidden" name="product" id="product-id" value="{{$product->id}}">
                ...
                <div class="row py-1">
                    <div class="col">
                        ...
                        <input type="number" name="quantity" id="quantity" class="form-control" placeholder="Quantity of Product" value="{{$sale->quantity}}">
                    </div>

                    <div class="col">
                        <label for="total">Total:</label>
                        <input type="number" name="total" id="total" class="form-control-plaintext" placeholder="Total Price" readonly value="{{$sale->total}}">
                    </div>
                </div>
